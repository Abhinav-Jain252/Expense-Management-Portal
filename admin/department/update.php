...
<head>
    <meta charset="utf-8" />
    <title>Admin Page - Update Department</title>
    <link
        href="../../style.css"
                        ...
                        <form action="#" method="POST" id="add_form" enctype="multipart/form-data">
                            <div id="show_item">
                                ...
                                <?php
                                    ...
                                    $showquery = "select * from department where department='$ids'";
                                    ...
                                    if(isset($_POST['submit'])){
                                        ...
                                        $updatequery = "UPDATE `department` SET `department`='$department' where sno='$sno'";
                                ...
                                ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        Department
                                        <input type="text" name="department" value="<?php echo $arrdata['department']; ?>" class="form-control" id="department">
                                    </div>
