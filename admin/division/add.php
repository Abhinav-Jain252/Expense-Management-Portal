...
<head>
    <meta charset="utf-8" />
    <title>Admin Page - Add Division</title>
    <link
        href="../../style.css"
...
<body>
                            ...
                            <div id="show_item">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        Division Name
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter division name" required>
                                    </div>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $result = mysqli_query($conn2,"INSERT INTO `division`(`division`) VALUES ('$name')");
