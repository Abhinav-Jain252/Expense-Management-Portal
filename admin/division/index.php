...
<head>
    <meta charset="utf-8" />
    <title>Admin Page - Division</title>
    <link
        href="../../style.css"
        ...
        <div class="main-section pd-bottom-64px wf-section">
            <div class="container-default w-container">
                <div class="grid-2-columns main-dashboard-grid">
                    ...
                    <div class="container">
                <div class="col-lg-12">
                <h1 style="font-size: 25px" class="text-center">Division's List</h1>
                    
                    <a name="add" id="add" class="btn btn-primary float-right" href="add.php" role="button">Add a new division</a>
                    ...
                    <table class="table table-striped table-hover bordered">
                        ...
                        <tbody>
                        <?php
                            $selectquery = "SELECT * FROM division";
                        ...
                        <tr>
                            ...
                            <td> 
                                <a href="update.php?id=<?php echo $res['division']; ?>" data-toggle="tooltip" data-placement="bottom" title="UPDATE"> 
                                <i class="fa fa-edit" id="update" aria-hidden="true"></i></a>
                            </td>
                            <td>
                                <a href="delete.php?id=<?php echo $res['division']; ?>" data-toggle="tooltip" data-placement="bottom" title="DELETE"> 
