...
<head>
    <meta charset="utf-8" />
    <title>Admin Page - Update Location</title>
    <link
        href="../../style.css"
        ...
        <div class="row my-4">
            <div class="col-lg-10 mx-auto">
                ...
                $ids = $_GET['id'];
                                    ...
                                    $showquery = "select * from location where location='$ids'";
                                    ...
                                    if(isset($_POST['submit'])){
                                        ...
                                        $updatequery = "UPDATE `location` SET `location`='$location' where sno='$sno'";
                                ...
                                ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        Location
                                        <input type="text" name="location" value="<?php echo $arrdata['location']; ?>" class="form-control" id="location">
                                    </div>
