...
<head>
    <meta charset="utf-8" />
    <title>Admin Page - Location</title>
    <link
        href="../../style.css"
        ...
        <div class="main-section pd-bottom-64px wf-section">
            <div class="container-default w-container">
                <div class="grid-2-columns main-dashboard-grid">
                        ...
                        <div id="w-node-_33df89bc-f82c-cc1e-d5c4-4959632564a9-632564a9" class="sidebar-container">
                            <div class="grid-1-column sidebar-links-grid mg-bottom-48px">
                                ...
                                <span class="las la-location-arrow"></span>
                                    <div class="text-100 medium active">Location</div>
                    ...
                    <div class="container">
                <div class="col-lg-12">
                <h1 style="font-size: 25px" class="text-center">Location's List</h1>
                    <a name="add" id="add" class="btn btn-primary float-right" href="add.php" role="button">Add a new location</a>
                    ...
                    <table class="table table-striped table-hover bordered">
                        ...
                        <tr>
                            ...
                            <td> 
                                <a href="update.php?id=<?php echo $res['location']; ?>" data-toggle="tooltip" data-placement="bottom" title="UPDATE"> 
                                <i class="fa fa-edit" id="update" aria-hidden="true"></i></a>
                            </td>
                            <td>
                                <a href="delete.php?id=<?php echo $res['location']; ?>" data-toggle="tooltip" data-placement="bottom" title="DELETE"> 
