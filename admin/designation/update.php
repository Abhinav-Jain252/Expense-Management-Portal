...
<head>
    <meta charset="utf-8" />
    <title>Admin Page - Update Designation</title>
    <link
        href="../../style.css"
        ...
        <div class="row my-4">
            <div class="col-lg-10 mx-auto">
                ...
                $ids = $_GET['id'];
                                    ...
                                    $showquery = "select * from designation where designation='$ids'";
                                    ...
                                    if(isset($_POST['submit'])){
                                        ...
                                        $updatequery = "UPDATE `designation` SET `designation`='$designation' where sno='$sno'";
                                ...
                                ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        Designation
                                        <input type="text" name="designation" value="<?php echo $arrdata['designation']; ?>" class="form-control" id="designation">
                                    </div>
