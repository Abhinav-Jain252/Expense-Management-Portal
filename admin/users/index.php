        ...
        <div class="main-section pd-bottom-64px wf-section">
            <div class="container-default w-container">
                <div class="grid-2-columns main-dashboard-grid">
                    ...
                    <?php 
                        $q = "Select * from login where usertype='user'";
                        $query = mysqli_query($conn2,$q);
                    ?>

           <div class="container">
               <div class="col-lg-12">
                   <h1 style="font-size: 25px" class="text-center">User's List</h1>
                   <a name="add" id="add" class="btn btn-primary float-right" href="add.php" role="button">Add a new user</a>
                   ...
                   <table class="table table-striped table-hover bordered">
                       ...
                       <?php
                            ...
                            $selectquery = "SELECT * FROM `login` WHERE usertype = 'user'";
                       ...
                       <tr>
                           ...
                           <td> 
                            ...
                            <td>
                                <a href="delete.php?id=<?php echo $res['username']; ?>" data-toggle="tooltip" data-placement="bottom" title="DELETE"> 
