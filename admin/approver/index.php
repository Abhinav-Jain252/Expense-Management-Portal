...
<head>
    <meta charset="utf-8" />
    <title>Admin Page - Approver's List</title>
    <link
        href="../../style.css"
        ...
        <div data-w-id="da732deb-5db6-156b-08c9-e9fd059bc49f" data-animation="default" data-collapse="medium"
            ...
            <div class="container-default w-container">
                <div class="header-content-wrapper"><a href="../dashboard/index.php" aria-current="page"
                    ...
                    <div style="text-align: center;"><?php $user = $_COOKIE['user'];  echo $user ?> </div>
        ...
        <div class="main-section pd-bottom-64px wf-section">
            <div class="container-default w-container">
                <div class="grid-2-columns main-dashboard-grid">
                        ...
                        <div id="w-node-_33df89bc-f82c-cc1e-d5c4-4959632564a9-632564a9" class="sidebar-container">
                            <div class="grid-1-column sidebar-links-grid mg-bottom-48px">
                                ...
                                <span class="las la-user-plus"></span>
                                    <div class="text-100 medium  active">Approvers</div>
                    ...
                    <?php
                $q = "Select * from login where usertype='approver'";
            ...
            <div class="container">
                <div class="col-lg-12">
                <h1 style="font-size: 25px" class="text-center">Approver's List</h1>
                    <a name="add" id="add" class="btn btn-primary float-right" href="add.php" role="button">Add a new approver</a>
                    ...
                    <table class="table table-striped table-hover bordered">
                        ...
                        <?php
                            ...
                            $selectquery = "SELECT * FROM `login` WHERE usertype = 'approver'";
                        ...
                        <tr>
                            ...
                            <td> 
                                <a href="update.php?id=<?php echo $res['username']; ?>" data-toggle="tooltip" data-placement="bottom" title="UPDATE"> 
                                <i class="fa fa-edit" id="update" aria-hidden="true"></i></a>
                            </td>
                            <td>
                                <a href="delete.php?id=<?php echo $res['username']; ?>" data-toggle="tooltip" data-placement="bottom" title="DELETE" onclick='return checkdelete()'> 
                                <i class="fa fa-trash" id="trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        <?php
                        }
