...
<head>
    <meta charset="utf-8" />
    <title>Admin Page - Add Approver</title>
    <link
        href="../../style.css"
...
<body>
                        ...
                        <form action="#" method="POST" id="add_form" enctype="multipart/form-data">
                            <div id="show_item">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        Employee ID
                                        <input type="text" name="emp_id" class="form-control" id="usertype" placeholder="Enter Employee ID">
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        usertype
                                        <input type="text" name="usertype" class="form-control" id="usertype" value="approver" readonly>
                                    </div>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $result = mysqli_query($conn2,"INSERT INTO `login`(`name`, `phone`, `username`, `password`, `usertype`,`emp_id`) VALUES ('$name','$phone','$username','$password','$usertype','$emp_id')");
